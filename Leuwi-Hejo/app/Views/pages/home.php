...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateNavbarLink(themeIndex) {
            const navLinks = document.querySelectorAll('.navbar a, .navbar-extra a');
            // Corrected selector - remove the dot if using getElementById
            const navSpan = document.getElementById('span-navbar');

            // Warna berdasarkan tema
            let linkColor, hoverColor, navSpanColor;

            switch (themeIndex) {
                case 0: // Tema Pagi
                    linkColor = 'rgba(58, 47, 47, 0.85)';
                    hoverColor = '#ffffff';
                    navSpanColor = 'rgba(82, 65, 65, 0.7)';
                    break;
                case 1: // Tema Siang
                    linkColor = 'rgba(112, 66, 20, 0.85)';
                    hoverColor = '#ffffff';
                    navSpanColor = 'rgba(180, 100, 20, 0.7)';
                    break;
                case 2: // Tema Sore
                    linkColor = 'rgb(248, 181, 95)';
                    hoverColor = '#ffffff';
                    navSpanColor = 'rgba(214, 153, 46, 0.7)';
                    break;
                case 3: // Tema Malam
                    linkColor = 'rgba(143, 230, 222, 0.85)';
                    hoverColor = '#ffffff';
                    navSpanColor = 'rgba(100, 200, 190, 0.7)';
                    break;
                default:
                    linkColor = 'rgba(58, 47, 47, 0.85)';
                    hoverColor = '#3b2f2f';
                    navSpanColor = 'rgba(255, 15, 15, 0.7)';
            }

            // Update warna pada link navbar
            ...
            // Apply the navSpanColor to the navSpan element if it exists
            if (navSpan) {
                navSpan.style.color = navSpanColor;
            } else {
                console.log('Element with ID "span-navbar" not found');
            }
        }
